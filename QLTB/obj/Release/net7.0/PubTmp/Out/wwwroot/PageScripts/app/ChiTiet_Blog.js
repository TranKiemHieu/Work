...
$(document).ready(function () {
    ...
    Promise.all([loadContent(), loadSidebar1(), loadSidebar2(), loadSectionBottom()])
    ...
    function loadSidebar1(pageIndex = 1) {
    ...
    function loadSidebar2(pageIndex = 1) {
    ...
    function loadSectionBottom(pageIndex = 1) {
